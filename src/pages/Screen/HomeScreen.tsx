...
<div className='w-full h-[95vh] font-bold flex justify-center items-center font-poppins'>
  <div className='flex justify-center items-center flex-col max-sm:flex-col-reverse'>
    ...
    <div className="w-full sm:w-[55vw] h-[80vh] flex items-center justify-center flex-col mt-20">
      ...
      <div className="w-full sm:w-[100%] h-[500px] mt-20 flex justify-between max-sm:flex-col-reverse">
        ...
        <div className="w-full sm:w-1/2 flex justify-center">
          <div className="h-[520px] w-[520px] phone:rounded-md tablet:h-[300px] tablet:w-[300px] rounded-full border border-[#ff7e20] flex justify-center items-center">
