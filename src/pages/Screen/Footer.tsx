...
const Footer = () => {
  return (
    <div className='w-full  phone:hidden flex justify-center '>
        <div className='w-[60vw] flex justify-between flex-col  tablet:hidden'>
            <span className='text-[30px] font-semibold mt-10 '>Text Me, let's talk </span>
           <div className="flex ">
           <div>
            <div className='w-[500px] h-[150px] border-y-2 mt-10 border-black flex items-center '>
                <div className="text-[30px] px-3 py-3 rounded-full bg-blue-200">
                <FiMessageSquare /></div>
                <div className=" flex flex-col ml-5">
                <span>Email</span>
                <span>Oluwafemijosephine5@gmail.com</span>
                </div>
            </div>
           ...
           <button className="w-[230px] h-[230px]  flex  items-center justify-center text-white text-[50px] bg-[#ff7e20] rounded-full "><CiLocationArrow1 /></button>
   </a>
    ...
    <div className='w-full  md:w-3/4 lg:w-2/3   flex-col justify-between hidden  tablet:flex'>
