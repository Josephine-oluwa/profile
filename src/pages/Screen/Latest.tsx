...
//         <div className='w-[350px] h-[450px] flex flex-col justify-between  rounded'>
//             <div className='w-full h-[300px] rounded bg-pink-400 '>
//                 <img className='h-full object-cover rounded' src={hackcare}/> </div>
//             <span className='text-[20px] font-bold'>LyfeCare</span>
//             <span className='text-[20px] '> dummy text of the printing and typesetting industry What is  Lorem Ipsum?</span>
...
//         </div>
//         <div className='w-[350px] h-[450px] flex flex-col justify-between'>
//             <div className='w-full h-[300px] rounded bg-pink-400 '>
